...
The last three weeks of the program, on the other hand, consisted of applying the skills covered in the prior weeks. Each student was assigned to one of four projects based on their interest in each particular research area. I was fortunately put on my first-choice project, which is meant to investigate the research attitudes of populations of particular interest to Alzheimer's Disease research. 
...
The coordinators of ISI-BUDS were also generous enough to plan a few expeditions for us on a few of the weekends, where we went kayaking, whale watching, and went to the beach. 
